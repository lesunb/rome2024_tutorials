...
Estimate time to complete mission and recalculate path.
...
Use LIDAR to check for obstacles.
...
Use the TB4 camera and OpenCV or DepthAI to detect and identify obstacles.
